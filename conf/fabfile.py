...
env.project_virtual = '~/.virtualenvs/refreshmanhattanorg' 
env.activate = 'source ~/.virtualenvs/%s/bin/activate' % 'refreshmanhattanorg'
...
env.git_repo = "git@github.com:refreshmanhattan/%s.git" % PROJECT_ID
