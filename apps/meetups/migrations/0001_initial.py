...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('meetups_meetup', (
            ...
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendar.Event'], null=True, blank=True)),
    ...
    models = {
        ...
        'meetups.meetup': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['calendar.Event']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
